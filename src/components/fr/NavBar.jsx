    ...
    <nav>
        ...
        <ul className={`menu ${isOpen ? 'menuResponsive' : ''}`}>
            <li className="souligne">
                <NavLink to={{ hash: '#apropos' }} onClick={function(event){ handleClickScrollAbout(); handleClickMenu()}}>À PROPOS
                </NavLink>
            </li>
            <li className="souligne">
            ...
            <li className="langue">
                <NavLink className="fr langueSelect" to={{ pathname : '/'}}>FR</NavLink> <span>|</span>
                <NavLink className="en " to={{ pathname : '/en'}}>EN</NavLink>
            </li>
        </ul>
